 ...
 */
package org.openmrs.module.childgrowth.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.ChildGrowthControlsController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class ChildGrowthControlsController {
